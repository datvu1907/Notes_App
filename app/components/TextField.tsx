  ...
  return (
    ...
    >
      ...
      <View style={themed($inputWrapperStyles)}>
        ...
        <BlurView intensity={42} style={themed($inputWrapperStyles)}>
          <TextInput
            ref={input}
...
const $inputWrapperStyle: ThemedStyle<ViewStyle> = ({ spacing }) => ({
...
const $inputStyle: ThemedStyle<ViewStyle> = ({ typography, spacing }) => ({
  flex: 1,
  alignSelf: "stretch",
